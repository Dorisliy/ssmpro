...
public enum NotificationEventTypeCodeType {
     ...
     * 						<ul>
     * 						<li>A fixed-price listing ends with or without sales</li>
     * 						<li>An auction listing ends with no winning bidder</li>
     * 						</ul>
    ...
    /**
     * 
     * 						An informational alert sent to a user when an item is added to her or his bid group. DO NOT USE. This notification was REMOVED in 549.
     * 					
     * 
     */
    ...
    /**
     * 
     * 						This notification is sent to the seller informing them that a buyer has requested an order cancellation.
     * 					
     * 
     */
