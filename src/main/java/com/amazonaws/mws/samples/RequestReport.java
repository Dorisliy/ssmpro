...
//    }
     ...
     *
     */
    public static RequestReportResponse requestReport(String updatedAfter, String updatedBefore, String reportType,String accessKeyId,String secretAccessKey,String merchantId,String marketplaceId,String url) {
...
//        final String sellerDevAuthToken = "<Merchant Developer MWS Auth Token>";
        ...
        final IdList marketplaces = new IdList(Arrays.asList(marketplaceId)); //US; //US
        ...
        request.setStartDate(AmazonUtil.long2Gregorian(AmazonUtil.str2Date(updatedAfter)));
        request.setEndDate(AmazonUtil.long2Gregorian(AmazonUtil.str2Date(updatedBefore)));
    ...
    public static RequestReportResponse requestReport(XMLGregorianCalendar startDate, XMLGregorianCalendar endDate, String reportType,String accessKeyId,String secretAccessKey,String merchantId,String marketplaceId,String url) {
        final String appName = AmazonUtil.MWS_APP_NAME;
        final String appVersion = AmazonUtil.MWS_APP_VERSION;
