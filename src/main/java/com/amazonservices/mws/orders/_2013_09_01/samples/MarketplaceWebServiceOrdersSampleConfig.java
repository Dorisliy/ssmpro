...
public class MarketplaceWebServiceOrdersSampleConfig {
    ...
    private static final String accessKey = "AKIAIV4LJOLMKO6YK2EA";

    /** Developer AWS secret key. */
    private static final String secretKey = "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";

    /** The client application name. */
    private static final String appName = "aidee";
