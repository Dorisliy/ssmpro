...
public class BaseJsonResult {
    ...
    public static BaseJsonResult build(Integer status, String msg) {
        return new BaseJsonResult(status, msg, null);
    }
    ...
    /**
     * 将json结果集转化为BaseJsonResult对象
     *
     * @param jsonData json数据
     * @param clazz BaseJsonResult中的object类型
     * @return
     */
